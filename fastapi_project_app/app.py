...
description = """
fastapi_project_app API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapi_project_app",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapi_project_app.com/terms/",
    contact={
        "name": "gassantos",
        "url": "http://fastapi_project_app.com/contact/",
        "email": "gassantos@fastapi_project_app.com",
    },
    license_info={
        "name": "The Unlicense",
