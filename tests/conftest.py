...
# WARNING: Ensure imports from `fastapi_project_app` comes after this line
from fastapi_project_app import app, settings, db  # noqa
from fastapi_project_app.cli import create_user, cli  # noqa
